...
function WeatherWidget () {
  ...
  ****************************************************/
  function outputElement(i, inEdit) 
  {
    ...
    tbl.setAttribute("class","msu-city-element"); 
    ...
    imageHolder.align= "center";
        ...
        image.width = "200px";
          ...
          if(cityList[i].rank == 0){ cityName.setAttribute("class","text-link msu-primary-city-label");}
          else { cityName.setAttribute("class","text-link msu-city-label");}
