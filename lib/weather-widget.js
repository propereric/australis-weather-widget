...
function WeatherWidget () {
                ...
                if(document) {
	              ...
	              var y = pageWorkers.Page({
                    ...
                    onMessage: function(iObject) {
                      ...
                      if( i == 0 ){ iconImage = iObject; badgeTemp = cityList[i].temp+" F"; }
                    }
                  });
  ...
  function onSetIcon() {
    if(cityList.length > 0) {
      ...
      document.getElementById("msu-weather-image").setAttribute("src",cityList[0].image);
    ...
    widgetCreated: function(node) {
      ...
      let container = doc.createElement("vbox");      
        ...
        container.pack = "end";
      	...
      	let badge = doc.createElement("box"); 
