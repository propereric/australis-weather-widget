              ...
              onMessage: function(wObject) 
              {
                ...
                { 
                  ...
                  else 
                  {
                    ...
                    if(tempUnit == "Celsius") { badgeTemp = fahrenheitToCelsius(cityList[i].temp)+"°"; }///////
...
//
    ...
    toggleContainer.align = "center";
      ...
      toggleTempHolder.setAttribute("id","msu-toggle-temp-holder");
        ...
        toggleTempButton.setAttribute("class", "msu-toggle-button");
        toggleTempButton.setAttribute("id", "msu-toggle-button-label");
