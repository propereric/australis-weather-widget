...
function WeatherWidget () {
  ...
  ****************************************************/
  function customizeClicked(event) 
  {
    ...
    let toggleContainer = document.getElementById("msu-toggle-container");
          ...
          var x = pageWorkers.Page(
          {
              ...
              onMessage: function(wObject) 
              {
                ...
                { 
                  ...
                  {
                    iconImage = returnIconImage(cityList[i].code);
                    badgeTemp = cityList[i].temp+"°";//needs to change
                  }
                }
                if( document )
                { 
  ...
  ****************************************************/
  function onSetIcon() 
  {
    if(cityList.length > 0) 
    {
      ...
      if(tempUnit == "Fahrenheit"){ document.getElementById("msu-weather-badge").setAttribute("badge",cityList[0].temp+"°");}
      else { document.getElementById("msu-weather-badge").setAttribute("badge",fahrenheitToCelsius(cityList[0].temp)+"°"); }
      iconImage = cityList[0].image;
      if(tempUnit == "Fahrenheit") { badgeTemp = cityList[0].temp+"°"; }
      else { badgeTemp = fahrenheitToCelsius(cityList[0].temp)+"°"; }
    }
    else 
    {
  ...
  function outputElement(i, inEdit) 
  {
    ...
    imageHolder.setAttribute("class","msu-city-image-holder");
        ...
        image.width = "200px";
          ...
          //let nameContainer = document.createElement("hbox");
          ...
          //let tempContainer = document.createElement("hbox");

            let temperature = document.createElement("label");
            if(tempUnit == "Fahrenheit"){ temperature.setAttribute("value",""+cityList[i].temp+"°"); }
            else { temperature.setAttribute("value",fahrenheitToCelsius(cityList[i].temp)+"°"); }
  ...
  ****************************************************/
  function injectUI () 
  {
    ...
    let toggleContainer = document.createElement("hbox");
    toggleContainer.setAttribute("id","msu-toggle-container");
    toggleContainer.style.display = "none";
    toggleContainer.align = "center";

      let toggleDistanceHolder = document.createElement("vbox");
      toggleDistanceHolder.setAttribute("id","msu-toggle-distance-holder");
      toggleDistanceHolder.align = "left";
